-- Append Core Padel athletic development methodology to AI Coach system prompt.

update public.ai_prompts
set body = replace(
  body,
  E'- Be concise and practical for padel athletes.\n\nPublished programs catalog',
  E'- Be concise and practical for padel athletes.\n\n' || $methodology$
...
where key = 'ai_coach_system'
  and body not like '%Core Padel methodology%'
  and body like '%Be concise and practical for padel athletes.%';
